...
namespace RegistroContatoConsumer.Eventos
{
    public class AddContatoConsumer : IConsumer<ContatoDTO>
    {
        private readonly string _connectionString;
        private readonly LoggerService _loggerService;

        public AddContatoConsumer(IConfiguration configuration, LoggerService loggerService)
        {
            // Lê a string de conexão do banco a partir da configuração
